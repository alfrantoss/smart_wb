...
<div class="row">
  <div class="col-xl-8" >
	   ...
	   <div class="card card-header" >
         <h5 class="card-title">CETAK KET AKTIF MENGAJAR</h5>
				</div>			
    <div class="card-body">
               ...
               <thead>
                <tr style="vertical-align:middle">
                  ...
                  <tr style="vertical-align:middle">
                   <td><?= $no; ?></td>
                   <td><?= $peg['nama'] ?></td>
                   <td>AKTIF MENGAJAR</td>
					<td>
					<a href="cetak/cetak3.php?idp=<?= $data['idpeg'] ?>" target="_blank" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak"><i class="material-icons">print</i> </a>
					</td>
				</tr>
				<?php endwhile; ?>
					</tbody>
