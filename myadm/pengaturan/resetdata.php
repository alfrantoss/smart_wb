...
?>  
                            ...
                            <div class="col-xl-8">
                                <div class="card widget widget-list">
									...
									<div class="pull-right"> 
									 <button id="confirm" class="btn btn-danger kanan">RESET</button>
									</div>
									</div>
                                    <div class="card-body">
                                            ...
                                            <li class="widget-list-item widget-list-item-red">
                                                ...
                                                <span class="widget-list-item-description">
                                                    <a href="#" class="widget-list-item-description-title">
                                                      RESET DATABASE ADMINISTRASI
                                                    </a>
                                                    <span class="widget-list-item-description-subtitle">
                                                     Database ADMINISTRASI dikosongkan kembali ke awal
                                                    </span>
                                                </span>
                                            </li>
		    	...
		    	Swal.fire({
				  title: 'RESET DATABASE ADMINISTRASI',
				  text: "Database ADMINISTRASI akan dikosongkan !",
				  type: 'warning',
