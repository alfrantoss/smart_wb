...
$idujian = @$_GET['id'];
$sqlx = mysqli_query($koneksi, "SELECT * FROM berita a LEFT JOIN banksoal b ON a.id_bank=b.id_bank LEFT JOIN mapel c ON b.nama=c.kode WHERE a.id_berita='$idujian'");
...
<div style='background:#fff; width:97%; margin:0 auto; height:90%;'>
	<table border='0' width='100%'>
		<tr>
			...
			<td rowspan='7' style="width:'120'; text-align:center">
				<img src="../../images/<?= $setting['logo'] ?>" width='80px'>
			</td>
		</tr>
		<tr>
	...
	<table style="width:95%">
		...
		<tr height='30'>
			...
			<td height='30' width='30%'>NPSN</td>
			<td height='30' width='60%' style='border-bottom:thin solid #000000'><?= $setting['npsn'] ?></td>
		</tr>
		<tr height='30'>
	...
	<table style="width:95%; margin-left:10px">
		...
		<tr>
			...
			<td width='20%'>Kepala Madrasah</td>
