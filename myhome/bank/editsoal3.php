				 ...
				 <div class="col-md-6">
                   ...
                   <div class="tab-content" id="pills-tabContent">
                       <div class="tab-pane fade active show" id="pills-A" role="tabpanel" aria-labelledby="pills-A-tab">
						...
						<label class="checkbox kanan"><input class='hidden radio-label' type='checkbox' <?php in_array ('A', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='A' />
						...
						<label class="checkbox kanan"><input class='hidden radio-label' type='checkbox' <?php in_array ('B', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='B' />
											<span class="check"></span></label>
											<p>
							<div class='form-group'>
						...
						<label class="checkbox kanan"><input class='hidden radio-label' type='checkbox' <?php in_array ('C', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='C' />
											<span class="check"></span></label>
											<p>
						<div class='form-group'>
						...
						<label class="checkbox kanan"><input class='hidden radio-label' type='checkbox' <?php in_array ('D', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='D' />
											<span class="check"></span></label>
											<p>
						<div class='form-group'>
					 ...
					 <div class="tab-pane fade" id="pills-E" role="tabpanel" aria-labelledby="pills-E-tab">
						...
						<label class="checkbox kanan"><input class='hidden radio-label' type='checkbox' <?php in_array ('E', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='E' />
											<span class="check"></span></label>
											<p>
						<div class='form-group'>
