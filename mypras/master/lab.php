...
?>           
                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="bold">RUANG LABORATORIUM</h5>
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover" style="width:100%;font-size:12px">
											...
											<?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM sapras_ruang WHERE jenis='umum' and ket='Lab'"); 
											...
											$no++;
											   ?>
												...
												<td>												
												<a href="?pg=<?= enkripsi('rlab') ?>&ac=<?= enkripsi('edit') ?>&id=<?= $data['id'] ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="material-icons">edit</i> </a>											
											...
											$.ajax({
											   url: 'master/tlokasi.php?pg=hapus',
												...
												width: "30%"
													...
													setTimeout(function() {
														window.location.replace('?pg=<?= enkripsi("rlab") ?>');
													}, 2000);
												}
											});
										}
                 ...
                 <script>
						$('#formbarang').submit(function(e) {
								...
								$.ajax({
									type: 'POST',
									 url: 'master/tlokasi.php?pg=tambah_lab',
