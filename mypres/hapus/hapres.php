								...
								<h5 class="card-title">DATA PRESENSI</h5>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%">
				                            ...
				                            $absis = mysqli_num_rows(mysqli_query($koneksi, "SELECT bulan,level FROM absensi WHERE bulan='$data[bln]' AND level='siswa'"));
											$abpeg = mysqli_num_rows(mysqli_query($koneksi, "SELECT bulan,level FROM absensi WHERE bulan='$data[bln]' AND level='pegawai'"));
											$no++;
											   ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
