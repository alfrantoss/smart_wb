...
mysqli_query($koneksi,"UPDATE status_face SET mode='3'");
?>       
	...
	<?php if ($ac == '') : ?>
                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">DATA FACE RECOGNITION SISWA</h5>
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
											...
											<?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM datareg WHERE folder<>'' AND level='siswa' ORDER BY id DESC"); 
						   ...
						   <select class="form-select" name="kelas" id="kelas" required style="width: 100%">
							   <option value="">Pilih Kelas</option>
                                ...
                                $('#kelas').change(function() {
                                    ...
                                    location.replace("?pg=<?= enkripsi('faces') ?>&ac=siswa&k=" + k );
                                }); 
                            </script>
		      ...
		      <?php elseif ($ac == 'siswa') : ?>			
					<div class="row">
                          <div class="col-md-7">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">REGISTRASI FACE RECOGNITION SISWA</h5>
     ...
     <?php 
       $sql=mysqli_query($koneksi,"SELECT * FROM siswa WHERE kelas='$_GET[k]' AND sts='0'");
